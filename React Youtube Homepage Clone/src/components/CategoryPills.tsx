...
// Buraya tekrar bak !!! dark ve default u böyle tanımlamamın sebebi variant kısmındaki hatayı çözememem
const dark="dark";
const def ="default";
...
// observer kullanmayınca ok ikonlarının konumunda sıkıntı çıkıyor
useEffect(()=>{
    ...
    return(
        <div ref={containerRef}  className="overflow-x-hidden relative">    
            <div className="flex whitespace-nowrap gap-3 transition-transform w-[max-content]" style={{transform: `translateX(-${translate}px)`}}>
                ...
                <Button key={category}
                // variant= {"dark"} 
                variant= {selectedCategory === category ? dark : def} 
